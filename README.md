...
[![CI](https://img.shields.io/github/actions/workflow/status/softspring/cms-blog-plugin/ci.yml?branch=5.4&style=flat-square&label=CI)](https://github.com/softspring/cms-blog-plugin/actions/workflows/ci.yml)
